# For this script at present, there can be only one disk components!!!
# And the sofening length calculation including no gas component (at present, only distinguish DM and non-DM(stars))
import agama
import numpy as np
import sys
